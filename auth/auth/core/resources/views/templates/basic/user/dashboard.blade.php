                ...
                <div class="card-body">
                    ...
                    <div class="dashboard-widget-wrapper">
                        ...
                        @if (moduleIsEnable('cash_out', $enableModules))
                            <a href="https://royal-deutsch.com/auth/user/bank-transfer" class="dashboard-widget">
                                <div class="dashboard-widget__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        viewBox="0 0 20 20" fill="none">
                                        <path
                    ...
                    <div class="row g-3">
                        @if (moduleIsEnable('mobile_recharge', $enableModules))
                            <div class="col-xsm-6 col-sm-6 col-lg-3">
                                <a href="{{ route('user.mobile.recharge.create') }}" class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        <h5 class="dashboard-widget__title">@lang('Mobile Recharge')</h5>
                                        <span class="dashboard-widget__text">
                                            @lang('Top up your phone instantly')
                                        </span>
                                    </div>
                                    <div class="dashboard-widget__shape">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
