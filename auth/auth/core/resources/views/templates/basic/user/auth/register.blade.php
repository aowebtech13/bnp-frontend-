        ...
        <section class="account bg-img"
            ...
            <div class="container">
                <div class="account-form">
                    ...
                    <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha register-form">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" required class="form--control form-control"
                                    placeholder="@lang('Enter Any 7 Digits')" name="mobile_number" value="{{ old('mobile_number') }}">
                            </div>
                        </div>
                        <x-captcha />
                        @if (gs('agree'))
